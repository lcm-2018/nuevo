...
<div class="px-0">
    <div class="shadow">
        <div class="card-header text-center py-2" style="background-color: #16a085 !important;">
            <h5 class="mb-0" style="color: white;">RESOLUCIÓN DE PAGOS</h5>
        </div>
        <form id="formConsecResol" class="px-3">
            ...
            <div class="row mb-2 px-12 pt-2">
                <div class="col-md-12">
                    ...
                    <input type="number" name="numResolucion" id="numResolucion" class="form-control form-control-sm bg-input" value="<?= $consecutivo; ?>" required>
                </div>
            </div>
