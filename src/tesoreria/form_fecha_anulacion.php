    ...
    <form id="formAnulaDocTes">
        ...
        <div class="shadow mb-3">
            <div class="card-header text-center py-2" style="background-color: #16a085 !important;">
                <h5 class="mb-0" style="color: white;"><i class="fas fa-lock fa-lg" style="color: #FCF3CF"></i>&nbsp;ANULACIÓN DE DOCUMENTO TESORERÍA</h5>
            </div>
            <div class="p-3">
                <div class="row mb-2">
                    <div class="col-md-6">
                        <label for="numDoc" class="small">NUMERO</label>
                        <input type="text" id="numDoc" name="numDoc" class="form-control form-control-sm bg-secondary-subtle" value="<?php echo $consecutivo; ?>" readonly>
                    </div>
                    <div class="col-md-6">
