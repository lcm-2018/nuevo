...
extract($config);
$elabora = [
    'nom_tercero' => isset($crp['usuario_act']) && trim($crp['usuario_act']) != ''
        ? $crp['usuario_act']
        : (isset($crp['usuario']) ? $crp['usuario'] : ''),
    'cargo' => isset($crp['cargo']) ? $crp['cargo'] : ''
];
$tercero_nombre = isset($crp['tercero']) ? $crp['tercero'] : '';
