...
<div class="px-0">
    <div class="shadow">
        <div class="card-header py-2 text-center" style="background-color: #16a085 !important;">
            <h5 class="mb-0" style="color: white;">ACTUALIZAR RECONOCIMIENTO</h5>
        </div>
        <form id="formUpRad">
            ...
            <div class="row px-4 pt-2">
                ...
                <div class="form-group col-md-4">
                    ...
                    <input type="text" id="numSolicitud" name="numSolicitud" class="form-control form-control-sm py-0 sm bg-input" aria-label="Default select example" value="<?php echo $datos['num_factura'] ?>">
                </div>
            </div>
            <div class="row px-4 pt-2">
                <div class="form-group col-md-12">
                    <label for="tercerocrp" class="small">TERCERO</label>
                    <input type="text" id="tercerocrp" class="form-control form-control-sm py-0 sm bg-input" aria-label="Default select example" value="<?php echo $datos['tercero'] ?>">
