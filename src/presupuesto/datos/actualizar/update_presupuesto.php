...
try {
    ...
    if ($sql->rowCount() > 0) {
        ...
        Logs::guardaLog("UPDATE pto_presupuestos SET  id_tipo = $tipoPto,  nombre= '$nombrePresupuesto', descripcion= '$objeto', id_user_act= $iduser, fec_act= '$fecha' WHERE id_pto = $id");
        echo '1';
    } else {
