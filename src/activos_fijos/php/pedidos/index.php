...
$peReg = $permisos->PermisosUsuario($opciones, 5702, 2) || $id_rol == 1 ? 1 : 0;
        ...
        <div class="mt-3">
            <table class="table table-bordered table-sm col-md-3 w-25" style="font-size:85%">
                <tr class="text-center">
                    ...
                    <td style="background-color:DodgerBlue; color:white"><b>Aceptado</b></td>
...
$plantilla->addScriptFile("{$host}/src/activos_fijos/js/pedidos/pedidos.js?v=" . date("YmdHis"));
