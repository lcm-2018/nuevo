...
$peReg = $permisos->PermisosUsuario($opciones, 5706, 2) || $id_rol == 1 ? 1 : 0;
...
ob_start();
estados_detalle_mantenimiento('--Estado--');
...
<div class="card w-100">
    <div class="card-header bg-sofia text-white">
        ...
        <b>PROGRESO DE LOS MANTENIMIENTOS</b>
    </div>
    <div class="card-body p-2 bg-wiev">
        ...
        <div class="row mb-3">
            <div class="col-md-4 mb-2">
                <div class="row">
                    <div class="col-md-4">
                        <input type="text" class="filtro form-control form-control-sm bg-input" id="txt_idmant_filtro" placeholder="Id. Mantenimiento">
                    </div>
                    <div class="col-md-4">
        ...
        <div class="table-responsive shadow p-2">
            <table id="tb_progreso_mantenimientos" class="table table-striped table-bordered table-sm nowrap table-hover shadow w-100 align-middle" style="font-size:80%">
                <thead class="text-center">
                    <tr>
                        <th class="bg-sofia" rowspan="2">Id</th>
                        <th class="bg-sofia" colspan="3">Orden Mantenimiento</th>
                        <th class="bg-sofia" colspan="4">Activo Fijo</th>
                        <th class="bg-sofia" colspan="5">Mantenimiento</th>
                    ...
                    <tr>
                        ...
                        <th class="bg-sofia">Fec. Ini.</th>
                        <th class="bg-sofia">Fec. Fin</th>
...
$plantilla->addScriptFile("{$host}/src/activos_fijos/js/mantenimiento_prog/mantenimiento_prog.js?v=" . date("YmdHis"));
