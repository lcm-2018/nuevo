...
ob_start();
tipo_reporte_activos('--TIPO DE REPORTE--');
...
<div class="card w-100">
    ...
    <div class="card-body p-2 bg-wiev">
        ...
        <div class="row mb-2">
            ...
            <div class="col-md-2 mb-2">
                <select class="filtro form-select form-select-sm bg-input" id="sl_area_filtro">
                </select>
            </div>
            <div class="col-md-3">
                <div class="row mb-2">
        ...
        <div class="table-responsive shadow p-2">
            <table id="tb_activos" class="table table-striped table-bordered table-sm nowrap table-hover shadow align-middle w-100" style="font-size:80%">
                <thead class="text-center">
                    <tr>
                        ...
                        <th class="bg-sofia">Vr. Ultima Compra</th>
...
$plantilla->addScriptFile("{$host}/src/activos_fijos/js/existencias/existencias.js?v=" . date("YmdHis"));
