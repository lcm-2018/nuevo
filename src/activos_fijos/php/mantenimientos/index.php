...
$peReg = $permisos->PermisosUsuario($opciones, 5705, 2) || $id_rol == 1 ? 1 : 0;
$host = Plantilla::getHost();

// Construir opciones de combos
include '../common/cargar_combos.php';
ob_start();
tipos_mantenimiento('--Tipo Mantenimiento--');
$opcionesTipoMantenimiento = ob_get_clean();
ob_start();
terceros($cmd, '--Tercero--');
$opcionesTerceros = ob_get_clean();
ob_start();
estados_mantenimiento('--Estado--');
...
<div class="card w-100">
    <div class="card-header bg-sofia text-white">
        ...
        <b>ORDENES DE MANTENIMIENTO DE ACTIVOS FIJOS</b>
    </div>
    <div class="card-body p-2 bg-wiev">
        ...
        <div class="table-responsive shadow p-2">
            <table id="tb_mantenimientos" class="table table-striped table-bordered table-sm nowrap table-hover shadow w-100 align-middle" style="font-size:80%">
                <thead class="text-center">
                    <tr>
                        <th class="bg-sofia" rowspan="2">Id</th>
                        <th class="bg-sofia" rowspan="2">Fecha</th>
                        <th class="bg-sofia" rowspan="2">Hora</th>
                        <th class="bg-sofia" rowspan="2">Tipo</th>
                        <th class="bg-sofia" rowspan="2">Observaciones</th>
                        <th class="bg-sofia" colspan="2">Responsable</th>
                        <th class="bg-sofia" colspan="2">Periodo Mantenimiento</th>
                        <th class="bg-sofia" rowspan="2">Id.Estado</th>
                        <th class="bg-sofia" rowspan="2">Estado</th>
                        <th class="bg-sofia" rowspan="2">Acciones</th>
                    </tr>
                    <tr>
                        <th class="bg-sofia">Funcionario</th>
        ...
        <div class="mt-3">
            <table class="table table-bordered table-sm col-md-5 w-50" style="font-size:85%">
                <tr class="text-center">
                    ...
                    <td style="background-color:PaleTurquoise"><b>Aprobado</b></td>
                    <td style="background-color:DodgerBlue; color:white"><b>En Ejecución</b></td>
                    <td><b>Cerrado</b></td>
...
$plantilla->addScriptFile("{$host}/src/activos_fijos/js/mantenimientos/mantenimientos.js?v=" . date("YmdHis"));
