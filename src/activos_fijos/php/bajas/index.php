...
$peReg = $permisos->PermisosUsuario($opciones, 5709, 2) || $id_rol == 1 ? 1 : 0;
...
<div class="card w-100">
    ...
    <div class="card-body p-2 bg-wiev">
        ...
        <div class="table-responsive shadow p-2">
            <table id="tb_bajas" class="table table-striped table-bordered table-sm nowrap table-hover shadow w-100 align-middle" style="font-size:80%">
...
$plantilla->addScriptFile("{$host}/src/activos_fijos/js/bajas/bajas.js?v=" . date("YmdHis"));
