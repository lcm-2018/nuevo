...
try {
    ...
    if (($permisos->PermisosUsuario($opciones, 5703, 2) && $oper == 'add' && $_POST['id_detalle'] == -1) ||
        ($permisos->PermisosUsuario($opciones, 5703, 3) && $oper == 'add' && $_POST['id_detalle'] != -1) ||
        ($permisos->PermisosUsuario($opciones, 5703, 4) && $oper == 'del') || $id_rol == 1
    ) {
        ...
        if ($id_ingreso > 0) {
            ...
            if ($obj_ingreso['estado'] == 1) {
                ...
                if ($rs) {
                    ...
                    $proceso = "Se Modificó detalles de Órden de Ingreso de Activos Fijos Id: " . $id_ingreso . ", Fecha: " . $obj_ingreso['fec_ingreso'] . ", Detalle: " . $obj_ingreso['detalle'];
