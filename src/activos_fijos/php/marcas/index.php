...
$peReg = $permisos->PermisosUsuario($opciones, 5707, 2) || $id_rol == 1 ? 1 : 0;
...
<div class="card w-100">
    ...
    <div class="card-body p-2 bg-wiev">
        ...
        <div class="table-responsive shadow p-2">
            <table id="tb_marcas" class="table table-striped table-bordered table-sm nowrap table-hover shadow w-100" style="font-size:80%">
...
$plantilla->addScriptFile("{$host}/src/activos_fijos/js/marcas/marcas.js?v=" . date("YmdHis"));
