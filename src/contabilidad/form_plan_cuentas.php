        ...
        <div class="shadow mb-3">
            ...
            <div class="py-3 px-3">
                    ...
                    <div class="col-9">
                        <div class="input-group input-group-sm">
                            ...
                            <div class="input-group-append">
                                <button class="btn btn-outline-success" type="button" onclick="buscarCuentaPlan();"><span class="fas fa-search-plus "></span></button>
                            </div>
                ...
                <div class="row mb-2 mb-1">
                    ...
                    <div class="col-9">
                        <div id="divBanco">
                            <input type="text" id="nombre" name="nombre" class="form-control form-control-sm bg-input" value="<?php echo $nombre; ?>">
                            <input type="hidden" id="controlid" name="controlid" class="form-control form-control-sm bg-input" value="">
                        </div>
                    </div>
                </div>
                <div class="row mb-2 mb-1">
                    ...
                    <div class="col-9">
                        <select id="tipo" name="tipo" class="form-control form-control-sm bg-input" required>
                            <?php echo $lista; ?>
                        </select>
                    </div>
                </div>
                <div class="row mb-2">
                    ...
                    <div class="col-9">
                        <input type="number" id="numero" name="numero" class="form-control form-control-sm bg-input" value="<?php echo $nivel; ?>">
                    </div>
                </div>
            </div>
        </div>
