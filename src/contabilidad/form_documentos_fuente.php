        ...
        <div class="shadow mb-3">
            ...
            <div class="py-3 px-3">
                <div class="row mb-2 mb-1">
                    ...
                    <div class="col-9">
                        <input type="text" id="txtCodigo" name="txtCodigo" class="form-control form-control-sm bg-input" value="<?php echo $fuente['cod']; ?>">
                    </div>
                </div>
                <div class="row mb-2 mb-1">
                    <div class="col-3 text-end">
                    ...
                    <div class="col-9">
                        <input type="text" id="txtNombre" name="txtNombre" class="form-control form-control-sm bg-input" value="<?php echo $fuente['nombre']; ?>">
                    </div>
                </div>
                <div class="row mb-2 mb-1">
                    <div class="col-3 text-end">
