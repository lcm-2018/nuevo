        ...
        <form id="formGestRango">
            ...
            <div class="row mb-2 px-4 pt-2">
                <div class="col-md-12">
                    ...
                    <input type="text" class="form-control form-control-sm bg-input" id="buscaRetencion" value="<?= $datos['retencion']; ?>">
            ...
            <div class="row mb-2 px-4">
                <div class="col-md-4">
                    ...
                    <input type="number" class="form-control form-control-sm bg-input text-end" id="valor_base" name="valor_base" value="<?= $datos['valor_base']; ?>">
                </div>
                <div class="col-md-4">
                    <label for="valor_tope" class="small">Valor Tope</label>
                    <input type="number" class="form-control form-control-sm bg-input text-end" id="valor_tope" name="valor_tope" value="<?= $datos['valor_tope']; ?>">
                </div>
                <div class="col-md-4">
                    <label for="tarifa" class="small">Tarifa</label>
                    <input type="number" class="form-control form-control-sm bg-input text-end" id="tarifa" name="tarifa" value="<?= $datos['tarifa']; ?>">
                </div>
            </div>
        </form>
