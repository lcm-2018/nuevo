        ...
        <form id="formGestRetencion">
            ...
            <div class="row mb-2 px-4 pt-2">
                <div class="col-md-12">
                    ...
                    <select name="txtTipoRte" id="txtTipoRte" class="form-control form-control-sm bg-input">
            ...
            <div class="row mb-2 px-4">
                <div class="col-md-12">
                    ...
                    <input type="text" class="form-control form-control-sm bg-input" id="txtNombreRte" name="txtNombreRte" value="<?= $datos['nombre_retencion']; ?>">
                </div>
            </div>
            <div class="row mb-2 px-4">
                <div class="col-md-12">
                    <label for="codigoCta" class="small">Cuenta</label>
                    <input type="text" class="form-control form-control-sm bg-input" id="codigoCta" value="<?= $datos['cuenta']; ?>">
