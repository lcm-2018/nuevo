...
try {
    ...
    if (($permisos->PermisosUsuario($opciones, 5507, 2) && $oper == 'add' && $_POST['id_cuentafac'] == -1) ||
        ($permisos->PermisosUsuario($opciones, 5507, 3) && $oper == 'add' && $_POST['id_cuentafac'] != -1) ||
        ($permisos->PermisosUsuario($opciones, 5507, 4) && $oper == 'del') || $id_rol == 1
    ) {
