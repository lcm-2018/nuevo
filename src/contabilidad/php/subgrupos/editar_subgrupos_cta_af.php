...
try {
    ...
    if (($permisos->PermisosUsuario($opciones, 5509, 2) && $oper == 'add' && $_POST['id_subgrupocta_af'] == -1) ||
        ($permisos->PermisosUsuario($opciones, 5509, 3) && $oper == 'add' && $_POST['id_subgrupocta_af'] != -1) ||
