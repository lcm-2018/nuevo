...
try {
    ...
    if (($permisos->PermisosUsuario($opciones, 5508, 2) && $oper == 'add' && $_POST['id_ceccta'] == -1) ||
        ($permisos->PermisosUsuario($opciones, 5508, 3) && $oper == 'add' && $_POST['id_ceccta'] != -1) ||
        ...
        if ($id_cencos > 0) {
            ...
            if ($oper == 'del') {
                ...
                if ($rs) {
                    ...
                    $ruta = '../../../log';
                    $consulta = "DELETE FROM tb_centrocostos_cta WHERE id_cec_cta = $id";
