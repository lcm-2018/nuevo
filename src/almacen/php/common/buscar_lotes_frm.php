...
$checked = $proceso == 'mingr' ? '' : 'checked';
$es_clinico = $proceso == 'mspsr' ? 1 : $es_clinico;
$disabled  = $proceso == 'mspsr' ? 'disabled' : '';
...
<div class="px-0">
    <div class="shadow">
        <div class="card-header py-2 text-center" style="background-color: #16a085 !important;">
            <h7 class="text-white mb-0">BUSCAR ARTICULOS - LOTES</h7>
        </div>
        <div class="p-2">
            ...
            <form id="frm_buscar_lotes">
                ...
                <div class="row mb-2">
                    <div class="col-md-3">
                     ...
                     <div class="col-md-2">
                        <select class="filtro_lot form-select form-select-sm bg-input" id="sl_clinico_fil" <?php echo $disabled ?>>
                            <?php tipo_insumo('--Tipo Insumo--', $es_clinico); ?>
                        </select>
                    </div>
                    <div class="col-md-2">
                        <select class="filtro_lot form-select form-select-sm bg-input" id="sl_subgrupo_art_fil">
