...
ob_start();
tipo_reporte_movimientos('--TIPO DE REPORTE--');
    ...
    <div class="card-body p-2 bg-wiev">
        ...
        <div class="row mb-2">
            ...
            <div class="col-md-6">
                <div class="row mb-2">
                    <div class="col-md-3">
                        <input type="date" class="filtro form-control form-control-sm bg-input" id="txt_fecini_filtro" name="txt_fecini_filtro" placeholder="Fecha Inicio">
                    </div>
                    <div class="col-md-3">
                        <input type="date" class="filtro form-control form-control-sm bg-input" id="txt_fecfin_filtro" name="txt_fecfin_filtro" placeholder="Fecha Fin">
                    </div>
                    <div class="col-md-3">
        ...
        <div class="table-responsive shadow p-2">
            <table id="tb_articulos" class="table table-striped table-bordered table-sm nowrap table-hover shadow align-middle w-100" style="font-size:80%">
                <thead class="text-center">
                    <tr>
                        <th rowspan="2" class="bg-sofia">Id</th>
                        <th rowspan="2" class="bg-sofia">Código</th>
                        <th rowspan="2" class="bg-sofia">Nombre</th>
                        <th rowspan="2" class="bg-sofia">Subgrupo</th>
                        <th colspan="2" class="bg-sofia">Saldo Inicial</th>
                        <th colspan="2" class="bg-sofia">Entradas</th>
                        <th colspan="2" class="bg-sofia">Salidas</th>
                        <th colspan="2" class="bg-sofia">Saldo Final</th>
                    </tr>
                    <tr>
                        <th class="bg-sofia">Existencia</th>
                        <th class="bg-sofia">Valores</th>
...
$plantilla->addScriptFile("{$host}/src/almacen/js/movimiento_periodo/movimiento_periodo.js?v=" . date("YmdHis"));
