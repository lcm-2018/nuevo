...
try {
    ...
    if (($permisos->PermisosUsuario($opciones, 5005, 2) && $oper == 'add' && $_POST['id_detalle'] == -1) ||
        ($permisos->PermisosUsuario($opciones, 5005, 3) && $oper == 'add' && $_POST['id_detalle'] != -1) ||
        ($permisos->PermisosUsuario($opciones, 5005, 4) && $oper == 'del') || $id_rol == 1
    ) {
        ...
        if ($id_pedido > 0) {
            ...
            if ($obj_pedido['estado'] == 1) {
                ...
                if ($res['mensaje'] == 'ok') {
                    ...
                    $proceso = "Se Modificó detalles de Pedido de Almacén Id: " . $id_pedido . ", Fecha: " . $obj_pedido['fec_pedido'] . ", Detalle: " . $obj_pedido['detalle'];
