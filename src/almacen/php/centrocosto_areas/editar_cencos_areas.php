...
try {
    ...
    if (($permisos->PermisosUsuario($opciones, 5015, 2) && $oper == 'add' && $_POST['id_area'] == -1) ||
        ($permisos->PermisosUsuario($opciones, 5015, 3) && $oper == 'add' && $_POST['id_area'] != -1) ||
        ($permisos->PermisosUsuario($opciones, 5015, 4) && $oper == 'del') || $id_rol == 1
    ) {
