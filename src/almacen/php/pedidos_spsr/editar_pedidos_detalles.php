...
try {
    ...
    if (($permisos->PermisosUsuario($opciones, 5018, 2) && $oper == 'add' && $_POST['id_detalle'] == -1) ||
        ($permisos->PermisosUsuario($opciones, 5018, 3) && $oper == 'add' && $_POST['id_detalle'] != -1) ||
        ($permisos->PermisosUsuario($opciones, 5018, 4) && $oper == 'del') || $id_rol == 1
    ) {
        ...
        if ($id_pedido > 0) {
            ...
            if ($obj_pedido['estado'] == 1) {
                ...
                if ($res['mensaje'] == 'ok') {
                    ...
                    $proceso = "Se Modificó detalles de Pedido SPSR Id: " . $id_pedido . ", Fecha: " . $obj_pedido['fec_pedido'] . ", Detalle: " . $obj_pedido['detalle'];
