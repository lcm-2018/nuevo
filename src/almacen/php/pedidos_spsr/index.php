...
$peReg = $permisos->PermisosUsuario($opciones, 5018, 2) || $id_rol == 1 ? 1 : 0;
            ...
            <table id="tb_pedidos" class="table table-striped table-bordered table-sm nowrap table-hover shadow align-middle w-100" style="font-size:80%">
                <thead class="text-center">                               
                    <tr>
                        ...
                        <th colspan="2" class="bg-sofia">Unidad DE donde se solicita</th>
                        <th colspan="2" class="bg-sofia">Unidad Principal (Proveedor)</th>                                       
                        <th rowspan="2" class="bg-sofia">Valor Total</th>
                        <th rowspan="2" class="bg-sofia">Id.Estado</th>
                        <th rowspan="2" class="bg-sofia">Estado</th>
                        <th rowspan="2" class="bg-sofia">Ids Traslados</th>
...
$plantilla->addScriptFile("{$host}/src/almacen/js/pedidos_spsr/pedidos_spsr.js?v=" . date("YmdHis"));
