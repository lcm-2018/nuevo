...
if (isset($_POST['search']['value']) && $_POST['search']['value']) {
    ...
    $where .= " AND (far_medicamentos.cod_medicamento LIKE '%$search%' OR far_medicamentos.nom_medicamento LIKE '%$search%' OR far_medicamento_lote.lote LIKE '%$search%')";
}
...
if (!empty($objs)) {
    foreach ($objs as $obj) {
        ...
        if ($permisos->PermisosUsuario($opciones, 5007, 3) || $id_rol == 1) {
        ...
        if ($permisos->PermisosUsuario($opciones, 5007, 4) || $id_rol == 1) {
