...
try {
    ...
    if (($permisos->PermisosUsuario($opciones, 5003, 2) && $oper == 'add' && $_POST['id_detalle'] == -1) ||
        ($permisos->PermisosUsuario($opciones, 5003, 3) && $oper == 'add' && $_POST['id_detalle'] != -1) ||
        ($permisos->PermisosUsuario($opciones, 5003, 4) && $oper == 'del') || $id_rol == 1
    ) {
