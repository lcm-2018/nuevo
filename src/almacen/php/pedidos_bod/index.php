...
$peReg = $permisos->PermisosUsuario($opciones, 5011, 2) || $id_rol == 1 ? 1 : 0;
$host = Plantilla::getHost();

// Construir opciones de combos
include '../common/cargar_combos.php';
ob_start();
sedes_usuario($cmd, '--Sede Solicitante--');
$opcionesSedeUsuario = ob_get_clean();
ob_start();
sedes($cmd, '--Sede Proveedor--');
...
<div class="card w-100">
    ...
    <div class="card-body p-2 bg-wiev">
        ...
        <div class="row mb-2">
            <div class="col-md-2">
                <select class="form-select form-select-sm bg-input" id="sl_sedsol_filtro">
                    {$opcionesSedeUsuario}
                </select>
            </div>
            <div class="col-md-2">
                <select class="form-select form-select-sm bg-input" id="sl_bodsol_filtro">
                </select>
            </div>
            <div class="col-md-1">
        ...
        <div class="row mb-3">
            <div class="col-md-2">
                <select class="form-select form-select-sm bg-input" id="sl_sedpro_filtro">
                    {$opcionesSede}
                </select>
            </div>
            <div class="col-md-2">
                <select class="form-select form-select-sm bg-input" id="sl_bodpro_filtro">
                </select>
            </div>
            <div class="col-md-1">
            ...
            <table id="tb_pedidos" class="table table-striped table-bordered table-sm nowrap table-hover shadow align-middle w-100" style="font-size:80%">
                <thead>
                    <tr class="text-center">
                        ...
                        <th class="bg-sofia" rowspan="2">No. Pedido</th>
                        <th class="bg-sofia" rowspan="2">Fecha Pedido</th>
                        <th class="bg-sofia" rowspan="2">Hora Pedido</th>
                        <th class="bg-sofia" rowspan="2">Detalle</th>
                        <th class="bg-sofia" colspan="2">Unidad DE donde se solicita</th>
                        <th class="bg-sofia" colspan="2">Unidad Proveedor</th>
...
$plantilla->addScriptFile("{$host}/src/almacen/js/pedidos_bod/pedidos_bod.js?v=" . date("YmdHis"));
