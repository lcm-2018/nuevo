...
if (!empty($objs)) {
    foreach ($objs as $obj) {
        ...
        if ($permisos->PermisosUsuario($opciones, 5012, 1) || $id_rol == 1) {
            $examinar = '<a value="' . $id . '" class="btn btn-outline-primary btn-sm btn-circle btn_examinar" title="Tarjeta Kardex"><span class="fa fa-wpforms "></span></a>';
        }
        $data[] = [
            "id_lote" => $id,
