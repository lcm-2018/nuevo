...
$peReg = $permisos->PermisosUsuario($opciones, 5002, 2) || $id_rol == 1 ? 1 : 0;
...
<div class="card w-100">
    ...
    <div class="card-body p-2 bg-wiev">
        ...
        <div class="row mb-3">
            <div class="col-md-1">
                <input type="text" class="filtro form-control form-control-sm bg-input bg-input" id="txt_codigo_filtro" placeholder="Codigo">
            </div>
            <div class="col-md-2">
                <input type="text" class="filtro form-control form-control-sm bg-input bg-input" id="txt_nombre_filtro" placeholder="Nombre">
            </div>
            <div class="col-md-2">
                <select class="form-select form-select-sm bg-input" id="sl_subgrupo_filtro">
                    {$opcionesSubgrupo}
                </select>
            </div>
            <div class="col-md-2">
                <select class="form-select form-select-sm bg-input" id="sl_clinico_filtro">
                    {$opcionesClinico}
                </select>
            </div>
            <div class="col-md-1">
        ...
        <div class="table-responsive shadow p-2">
            <table id="tb_articulos" class="table table-striped table-bordered table-sm nowrap table-hover shadow w-100" style="font-size:80%">
                <thead class="text-center">
                    <tr>
                        ...
                        <th class="bg-sofia">Tope Mínimo</th>
                        <th class="bg-sofia">Tope Máximo</th>
                        <th class="bg-sofia">Existencia</th>
                        <th class="bg-sofia">Vr. Promedio</th>
                        <th class="bg-sofia">Uso Asistencial</th>
...
$plantilla->addScriptFile("{$host}/src/almacen/js/articulos/articulos.js?v=" . date("YmdHis"));
