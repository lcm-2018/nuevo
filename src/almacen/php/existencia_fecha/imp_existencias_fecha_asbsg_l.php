    ...
    <table style="width:100% !important">
        ...
        switch ($id_reporte) {
            ...
            case '3':
                $tabla .= '
                    <tr style="background-color:#CED3D3; text-align:center">
                        <th colspan="7">Sede-Bodega-Subgrupo</th>
                        <th>Vr. Parcial</th>
                        <th>Vr. Total</th>
                    </tr>';
                break;
        ...
        foreach ($objs as $obj1) {
            $tabla .= '
            <tr>
                <th colspan="8" style="text-align:left">' . strtoupper($obj1['nom_sede'] . ' - ' . $obj1['nom_bodega']) . '</th>
            ...
            foreach ($objg as $obj2) {
                if ($id_reporte == 1) {
                    $tabla .= '
                    <tr>
                        <th colspan="7" style="text-align:left">' . str_repeat('&nbsp;', 10) . strtoupper($obj2['nom_subgrupo']) . '</th>                        
                    ...
                    $tabla .= '
                    <tr>
                        <td colspan="7" style="text-align:left">' . str_repeat('&nbsp;', 10) . strtoupper($obj2['nom_subgrupo']) . '</td>
                        <td style="text-align:right">' . formato_valor($obj2['val_total_sg']) . '</td>
                    </tr>';
