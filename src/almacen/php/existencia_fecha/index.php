...
$opcionesLotes = ob_get_clean();

ob_start();
tipo_reporte_exi_fecha('--TIPO DE REPORTE--');
    ...
    <div class="card-body p-2 bg-wiev">
        ...
        <div class="row mb-2">
            ...
            <div class="col-md-4">
                <div class="row mb-2">
                    <div class="col-md-4">
                        <input type="date" class="filtro form-control form-control-sm bg-input" id="txt_fecha_filtro" name="txt_fecha_filtro" placeholder="Fecha Corte">
                    </div>                                        
                    <div class="col-md-4">
...
$plantilla->addScriptFile("{$host}/src/almacen/js/existencia_fecha/existencia_fecha.js?v=" . date("YmdHis"));
