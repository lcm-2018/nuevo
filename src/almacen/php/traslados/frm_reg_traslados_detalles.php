...
<div class="px-0">
    <div class="shadow">
        <div class="card-header py-2 text-center bg-sofia">
            <h5 class="text-white mb-0">REGISTRAR DETALLE EN TRASLADO</h5>
        </div>
        <div class="p-2">
            ...
            <form id="frm_reg_traslados_detalles">
                ...
                <div class=" row">
                    ...
                    <div class="col-md-3">
                        ...
                        <input type="number" class="form-control form-control-sm bg-input numberint" id="txt_can_tra" name="txt_can_tra" value="<?php echo $obj['cantidad'] ?>">
                    </div>
                    <div class="col-md-3">
