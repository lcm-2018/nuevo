...
ob_start();
tipo_reporte_exi_articulo('--TIPO DE REPORTE--');
...
$plantilla->addScriptFile("{$host}/src/almacen/js/existencia_articulo/existencia_articulo.js?v=" . date("YmdHis"));
