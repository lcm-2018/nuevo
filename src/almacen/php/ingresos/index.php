...
$peReg = $permisos->PermisosUsuario($opciones, 5006, 2) || $id_rol == 1 ? 1 : 0;
...
ob_start();
tipo_reporte_ingresos('--TIPO DE REPORTE--');
...
<div class="card w-100">
    ...
    <div class="card-body p-2 bg-wiev">
        ...
        <div class="row mb-2">
            ...
            <div class="col-md-2">
                <input type="text" class="filtro form-control form-control-sm bg-input" id="txt_numfac_filtro" placeholder="No. Factura">
            </div>
            <div class="col-md-3">
                <div class="row mb-2">
                    <div class="col-md-6">
        ...
        <div class="table-responsive shadow p-2">
            <table id="tb_ingresos" class="table table-striped table-bordered table-sm nowrap table-hover shadow align-middle w-100" style="font-size:80%">
                <thead class="text-center">
                    <tr>
                        ...
                        <th class="bg-sofia">No. Fac./Acta/Rem.</th>
                        ...
                        <th class="bg-sofia">No. Orden Compra</th>
...
$plantilla->addScriptFile("{$host}/src/almacen/js/ingresos/ingresos.js?v=" . date("YmdHis"));
