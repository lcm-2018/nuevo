            ...
            <form id="frm_reg_traslados">
                ...
                <div class="row mb-2">
                    <div class="col-md-3">
                        ...
                        <input type="text" class="form-control form-control-sm bg-input" id="txt_sede_origen" class="small" value="<?php echo $obj['nom_sede_origen'] ?>" readonly="readonly">
                    ...
                    <div class="col-md-3">
                        ...
                        <input type="text" class="form-control form-control-sm bg-input" id="txt_bodega_origen" class="small" value="<?php echo $obj['nom_bodega_origen'] ?>" readonly="readonly">
