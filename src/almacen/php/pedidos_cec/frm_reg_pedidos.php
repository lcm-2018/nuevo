...
<div class="px-0">
    <div class="shadow">
        <div class="card-header py-2 text-center bg-sofia">
            <h5 class="text-white mb-0">REGISTRAR PEDIDO DE DEPENDENCIA</h5>
        </div>
        <div class="p-2">
            ...
            <form id="frm_reg_pedidos">
                ...
                <div class="row mb-2">
                    <div class="col-md-4">
                        ...
                        <select class="form-select form-select-sm bg-input" id="sl_dependencia" name="sl_dependencia">
                            <?php centros_costo_usuario($cmd, '', $obj['id_cencosto']) ?>
                        </select>
                    </div>
                    <div class="col-md-4">
                        <label for="sl_sede_prov" class="small">Sede Proveedor</label>
                        <select class="form-select form-select-sm bg-input" id="sl_sede_prov" name="sl_sede_prov">
                            <?php sedes($cmd, '', $obj['id_sede']) ?>
                        </select>
                    </div>
                    <div class="col-md-4">
                        <label for="sl_bodega_prov" class="small">Bodega Proveedor</label>
                        <select class="form-select form-select-sm bg-input" id="sl_bodega_prov" name="sl_bodega_prov">
