                            ...
                            <table class="table table-sm table-striped table-bordered table-hover align-middle">
                                ...
                                <tbody id="tableReportesNomina">
                                    ...
                                    <tr>
                                     ...
                                     <tr>
                                        <td>6</td>
                                        <td class="text-start">LIQUIDACIÓN / FACTORES SALARIALES</td>
                                        <td></td>
                                        <td class="text-center">
                                            <button data-id="6" class="btn btn-outline-info btn-xs rounded-circle shadow me-1 reportes" title="Imprimir" text="P"><span class="fas fa-print fa-sm"></span></button>
                                        </td>
                                    </tr>
                                </tbody>
                            </table>   
