        ...
        <div class="shadow">
            ...
            <form id="formActualizaBnSv">
                ...
                <div class="row px-4 pt-2">
                    ...
                    <div class="col-md-8 mb-3">                        <label for="txtBnSv" class="small">NOMBRE DE BIEN O SERVICIO</label>
                        <input id="txtBnSv" type="text" name="txtBnSv" class="form-control form-control-sm bg-input" aria-label="Default select example" value="<?php echo $bnsv['bien_servicio'] ?>">
                    </div>
                </div>
