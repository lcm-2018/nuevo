...
$peReg = $permisos->PermisosUsuario($opciones, 3001, 2) || $id_rol == 1 ? 1 : 0;
...
<div class="card w-100">
    ...
    <div class="card-body p-2 bg-wiev">
        ...
        <div class="row mb-3">
            <div class="col-md-2">
                <input type="text" class="filtro form-control form-control-sm bg-input bg-input" id="txt_titulo_filtro" placeholder="Título">
            </div>              
            <div class="col-md-2">
        ...
        <div class="table-responsive shadow p-2">
            <table id="tb_consultas" class="table table-striped table-bordered table-sm nowrap table-hover shadow w-100" style="font-size:80%">
