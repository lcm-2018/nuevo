            ...
            <form id="frm_reg_consultas">
                ...
                <div class="row">
                    ...
                    <div class="col-md-2 mt-3">
                        <div class="text-white fw-bold p-2 rounded-top" style="background-color:#2C92B8">Parámetros</div>
                        <div class="table-responsive shadow p-2">             
                            <table id="tb_consulta_param" class="table table-striped table-bordered table-sm nowrap table-hover shadow w-100" style="font-size:80%">
                                <thead>
